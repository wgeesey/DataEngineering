...
def mssql_extract_dag():
    ...
    transform_task = SparkSubmitOperator(
        ...
        application="/home/wgeesey/airflow/dags/spark_jobs/transform_orders.py",
        conn_id="spark_default",
        application_args=[
            "--input_path", "/home/wgeesey/airflow/data/staging/orders.csv",
            "--output_path", "s3a://my-first-s3-data-lake/WWI/processed/orders.csv"
        ]
    )
