...
#S3_PARQUET_KEY = "WWI/analytics/orders/order_{{ ds_nodash }}"
...
def mssql_extract_dag2():
    ...
    spark_transform = BashOperator(
        ...
        /home/wgeesey/airflow/dags/spark_jobs/transform_orders2.py \
        --input_path s3a://my-first-s3-data-lake/WWI/raw/orders/order_{{ ds_nodash }}.csv \
        --output_path s3a://my-first-s3-data-lake/WWI/analytics/orders/order_{{ ds_nodash }}
        """
    )
